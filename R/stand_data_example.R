...
#' \enumerate{
#'   \item Initial densities stem/ha : 5102, 2500, 1111, 625, 277, 100
#'   \item Fertility : 40, 33, 26 (dominant height at 50 year)
#'   \item 10 repetitions are made for each pair of modalities
#'   }
#'
#' @format A data frame with 19078 rows and 27 variables:
#' \describe{
